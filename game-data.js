...
const gameQuestions = {
    ...
    chapter1: [
        ...
        { 
            id: 107, 
            type: 'fillblank', 
            title: '审计三方关系包括审计委托人、______和审计人员。',
    ...
    chapter2: [
        ...
        { id: 206, type: 'multiplechoice', title: '如果审计人员在审计过程中发现客户存在重大舞弊迹象，正确的做法是？', options: ['A. 立即向监管机构报告', 'B. 与管理层沟通并获取书面声明', 'C. 出具保留意见审计报告', 'D. 直接终止业务约定'], correctAnswer: 1, explanation: '发现舞弊迹象时，审计人员应当与管理层沟通，获取书面声明，并考虑对审计报告的影响。直接报告监管机构或终止业务约定不是首选做法。' },
    ...
    chapter3: [
        ...
        { id: 306, type: 'multiplechoice', title: '关于存货盘点，以下说法正确的是？', options: ['A. 盘点时企业人员必须在场', 'B. 盘点结果直接作为审计证据', 'C. 抽盘时可以由审计人员单独进行', 'D. 盘点结果无需与账面核对'], correctAnswer: 0, explanation: '存货盘点应当有企业相关人员在场，审计人员观察盘点过程并执行抽盘，盘点结果需要与企业账面记录核对。' },
...
const theaterEvents = [
    ...
    { id: 6, chapter: '第三章：十字路口', year: 3, scenario: 'HR办公室', description: '人力资源总监告诉你，公司有一个晋升机会，但需要你承诺未来三年不生育。你正在考虑这个提议，因为它关系到你的职业发展。', choices: 3 },
    { id: 7, chapter: '第三章：十字路口', year: 3, scenario: '家里', description: '你的父母从老家来看望你。饭桌上，他们询问你的工作情况，表达了对你长期加班的担忧。', choices: 3 },
    { id: 8, chapter: '第三章：十字路口', year: 3, scenario: '客户仓库', description: '在对客户进行存货盘点时，你发现仓库中有一部分存货的实际数量与账面不符。经过仔细检查，你怀疑这可能是管理层故意虚报的。', choices: 3 },
    ...
    { id: 13, chapter: '第五章：终极抉择', year: 6, scenario: '家里', choices: 3 },
...
const theaterEndings = [
    ...
    { id: 'special1', name: '无名英雄', condition: 'principle > 60 && courage > 50 && network < 50', category: '特殊' },
    { id: 'special2', name: '行业吹哨人', condition: 'courage > 90 && risk > 70', category: '特殊' },
    { id: 'special3', name: '传承者', condition: 'wisdom > 80 && network > 60', category: '特殊' },
    { id: 'special4', name: '流浪审计师', condition: 'pressure < 20 && principle > 70', category: '特殊' },
    { id: 'special5', name: '觉醒者', condition: 'courage > 80 && pressure < 30', category: '特殊' }
];
...
const lvDaDiQuestions = [
    { id: 1, title: '招股书中绿大地虚增资产为__________万元。', content: '招股书中绿大地虚增资产为__________万元。', hint: '观察图表中"招股书"对应的 青色柱形 （代表虚增资产）标注数值。', answer: '7011', explanation: '图表"招股书"栏目下，青色柱形（虚增资产）明确标注数值为7011万元，直接读取数据可得。' },
    { id: 2, title: '2007年年报中，绿大地虚增业务收入比虚增资产多__________万元。', content: '2007年年报中，绿大地虚增业务收入比虚增资产多__________万元。', hint: '先提取2007年年报的虚增资产（青色柱，2124万元）和虚增业务收入（蓝色柱，9660万元），再计算两者差值（虚增业务收入 - 虚增资产）。', answer: '7536', explanation: '2007年年报虚增业务收入为9660万元，虚增资产为2124万元，差值为 9660−2124=7536万元，通过减法运算得出。' },
    { id: 3, title: '2008年年报与2009年年报相比，虚增资产增加了__________万元。', content: '2008年年报与2009年年报相比，虚增资产增加了__________万元。', hint: '提取2008年年报虚增资产（16335万元）和2009年年报虚增资产（10407万元），计算差值（2008年数值 - 2009年数值）。', answer: '5928', explanation: '2008年年报虚增资产为16335万元，2009年年报虚增资产为10407万元，增加额为 16335−10407=5928万元，通过跨期间数值相减得到。' },
    { id: 4, title: '招股书中，虚增业务收入是虚增资产的__________倍（保留两位小数）。', content: '招股书中，虚增业务收入是虚增资产的__________倍（保留两位小数）。', hint: '提取招股书虚增业务收入（29610万元）和虚增资产（7011万元），计算除法（虚增业务收入 ÷ 虚增资产）并按要求保留小数。', answer: '4.22', explanation: '招股书虚增业务收入29610万元，虚增资产7011万元，倍数关系为 29610÷7011≈4.22（保留两位小数），通过除法运算与四舍五入规则得出。' },
    { id: 5, title: '2007 - 2009年年报中，虚增业务收入总和为__________万元。', content: '2007 - 2009年年报中，虚增业务收入总和为__________万元。', hint: '提取2007年年报（9660万元）、2008年年报（8565万元）、2009年年报（6856万元）的虚增业务收入，求和计算。', answer: '25081', explanation: '2007 - 2009年年报虚增业务收入分别为9660万、8565万、6856万，总和为 9660+8565+6856=25081万元，通过连续加法运算得出。' },
    ...
    { id: 7, title: '2009年年报中，虚增业务收入比虚增资产少__________万元。', content: '2009年年报中，虚增业务收入比虚增资产少__________万元。', hint: '提取2009年年报虚增资产（10407万元）和虚增业务收入（6856万元），计算差值（虚增资产 - 虚增业务收入）。', answer: '3551', explanation: '2009年年报虚增资产为10407万元，虚增业务收入为6856万元，差值为 10407−6856=3551万元，通过减法运算得出。' },
    { id: 8, title: '招股书虚增业务收入与2007年年报虚增业务收入的差值为__________万元。', content: '招股书虚增业务收入与2007年年报虚增业务收入的差值为__________万元。', hint: '提取招股书虚增业务收入（29610万元）和2007年年报虚增业务收入（9660万元），计算减法（招股书数值 - 2007年报数值）。', answer: '19950', explanation: '招股书虚增业务收入29610万元，2007年年报虚增业务收入9660万元，差值为 29610−9660=19950万元，通过跨报告期减法运算得到。' },
    { id: 9, title: '2008年年报虚增资产占该报告期虚增业务收入的比例约为__________%（保留一位小数）。', content: '2008年年报虚增资产占该报告期虚增业务收入的比例约为__________%（保留一位小数）。', hint: '提取2008年年报虚增资产（16335万元）和虚增业务收入（8565万元），计算除法（虚增资产 ÷ 虚增业务收入）并转换为百分比，保留一位小数。', answer: '190.7%', explanation: '2008年年报虚增资产16335万元，虚增业务收入8565万元，比例为 (16335÷8565)×100%≈190.7%（保留一位小数），通过除法、百分比转换与四舍五入规则得出。' }
];

// 银广夏案例问题
const yinGuangXiaQuestions = [
    { id: 1, title: '计算异常的年度增长率', content: `主营业务收入：1997年同比降__________，2000年同比暴增__________，2001年同比暴跌__________；<br>主要业务利润：1997年降__________，2000年暴增__________，2001年暴跌__________；<br>净利润：1997年降__________，2000年暴增__________，2001年暴跌__________。`, hint: `通过同比/环比增长率，识别指标"大起大落"的非正常经营迹象（造假常伴随短期指标异常冲高后崩盘）。可以对"主营业务收入、主营业务利润、净利润、每股收益、净资产收益率"计算相邻年度增长率（公式：增长率=(本年值−上年值)/上年值×100%）。`, answer: `主营业务收入：1997年同比降24.5%，2000年同比暴增72.8%，2001年同比暴跌92%；<br>主要业务利润：1997年降24.5%，2000年暴增177%，2001年暴跌67%；<br>净利润：1997年降3.2%（相对温和），2000年暴增227%，2001年暴跌226%。`, explanation: `核心指标（如2000年）的"冲高"与2001年的"断崖式回落"，违背真实业务"平稳或渐进式增长"的逻辑。` },
    { id: 2, title: '验证利润表指标的逻辑传导（主营收入→主营利润→净利润）', content: `毛利率：1999年为__________，2000年跳升至__________（增幅约__________），2001年回落至__________；<br>净利率：1999年为__________，2000年跳升至__________（增幅近__________），2001年回落至__________。`, hint: `真实业务中，"主营收入→主营利润→净利润"需满足成本费用合理扣减的逻辑（即毛利率、净利率不会出现无理由的剧烈波动）。计算毛利率（主营利润/主营收入）和净利率（净利润/主营收入），观察跨年度变化。`, answer: `毛利率：1999年为39.65%，2000年跳升至63.61%（增幅超50%），2001年回落至26.42%；<br>净利率：1999年为24.29%，2000年跳升至45.95%（增幅近90%），2001年回落至-26.93%。`, explanation: `2000年"毛利率、净利率"短期内暴涨，远超行业正常水平（银广夏主业为生物萃取，无技术突变支撑"暴利"，反映虚增收入时同步虚减成本费用的造假逻辑（虚构收入后，人为压低对应成本，导致主营利润虚高；再虚减期间费用，进一步推高净利润。` },
    { id: 3, title: '锚定关键盈利指标的联动性（净资产收益率、每股收益）', content: `ROE：1994 - 1999年维持在__________ ~ __________，2000年跳升至__________，2001年暴跌至__________；<br>EPS：1994 - 1999年在__________ ~ __________元波动，2000年跳升至__________元，2001年暴跌至__________元。`, hint: `验证"盈利质量"是否匹配（净资产收益率=净利润/平均净资产，每股收益=净利润/总股本；若股本/净资产无重大变动，二者应呈同趋势增长）。对比"净资产收益率（ROE）"与"每股收益（EPS）的年度走势。`, answer: `ROE：1994 - 1999年维持在10% - 15%，2000年跳升至34.56%，2001年暴跌至-3.77%；<br>EPS：1994 - 1999年在0.22 - 0.83元波动，2000年跳升至0.83元（同比增62.7%），2001年暴跌至-0.04元。`, explanation: `2000年ROE、EPS的"异动冲高"与2001年"断崖式回落"，不符合"真实盈利持续积累"的规律，而是造假推高短期指标后泡沫破裂的表现（银广夏通过虚构海外订单、伪造报关单等手段，虚增收入利润，短期内推高ROE、EPS吸引投资者）。` },
    { id: 4, title: '聚焦异常年份的造假指向性分析（以2000年为核心）', content: '结合银广夏"1998 - 2001年虚构天津广夏萃取产品出口"的造假背景，分析2000年"高增长"与2001年"暴跌"的业务实质，验证数据与造假逻辑的匹配性。', hint: '点击下方按钮查看答案解析', answer: '2000年"收入、利润、毛利率、ROE"的集体冲高，是虚构主营业务（无真实交易支撑）的结果（天津广夏不存在真实出口，报表数据全为伪造）；2001年数据暴跌，是造假难以为继的必然（监管介入+海外客户虚构被戳穿），体现"虚假业务的不可持续性"——这是识别财务造假的黄金指标（真实业务即使遇危机，也不会出现"一年内从暴增到暴跌92%"的极端波动）。', explanation: '2000年"收入、利润、毛利率、ROE"的集体冲高，是虚构主营业务（无真实交易支撑）的结果（天津广夏不存在真实出口，报表数据全为伪造）；2001年数据暴跌，是造假难以为继的必然（监管介入+海外客户虚构被戳穿），体现"虚假业务的不可持续性"——这是识别财务造假的黄金指标（真实业务即使遇危机，也不会出现"一年内从暴增到暴跌92%"的极端波动）。' },
